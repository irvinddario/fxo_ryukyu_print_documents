...
class stock_picking_wizard(models.TransientModel):
    ...
    def report_print(self):
        ...
        #return self.env['report'].get_action(self, 'fxo_ryukyu_print_documents.reporte_consumo_tipo_movimiento')
        ...
        return {'type': 'ir.actions.report.xml',
                'report_name': 'fxo_ryukyu_print_documents.reporte_consumo_tipo_movimiento',
                'report_type': 'q-web',
                'datas': data,
                'name': 'reporte.pdf'
                }
        ...
        #return self.env['report'].render('fxo_ryukyu_print_documents.reporte_consumo_tipo_movimiento', data)
